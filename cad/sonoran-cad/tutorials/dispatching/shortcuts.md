---
description: Record and automate flows with shortcuts!
---
...
<figure><img src="../../.gitbook/assets/image (620).png" alt="" width="375"><figcaption></figcaption></figure>

### Command Line Interface (CLI)

Shortcuts also integrate with the [CLI](command-line-interface-cli.md). Enter a **CLI Command** name to add the shortcut to your CLI options. Additionally, select **Add Step** > **CLI Variable** > name the variable and select the step where the variable's CLI answer should be entered.
