...
Our MacOS and Windows desktop application allows you to access [global hotkeys](../tutorials/other-features/configurable-hotkeys.md) regardless of whether or not the app is in-focus. You can even configure our [Stream Deck plugin](../integration-plugins/stream-deck-integration.md) to work with your deskop app!
