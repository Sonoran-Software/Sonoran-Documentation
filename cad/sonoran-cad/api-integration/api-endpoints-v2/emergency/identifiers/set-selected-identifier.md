...
```lua
local response = cad:selectIdentifierV2('00000000-0000-0000-0000-000000000000', 12)
...
response = instance.cad.selectIdentifierV2('00000000-0000-0000-0000-000000000000', 12)
