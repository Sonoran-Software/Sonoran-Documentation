...
local response = sonoran.cad:updateIdentifierV2('00000000-0000-0000-0000-000000000000', 12, {
    status = 2,
    unitNum = '1A-01',
    name = 'John Doe',
  })
...
response = instance.cad.updateIdentifierV2('00000000-0000-0000-0000-000000000000', 12, {
    "status": 2,
    "unitNum": '1A-01',
    "name": 'John Doe',
  })
...
var response = await sonoran.Cad.updateIdentifierV2(
...
openapi: "3.0.3"
info:
  title: "Sonoran CAD v2 - Update Identifier"
  version: "1.0.0"
  description: "Update an existing identifier for an account."
servers:
  -
