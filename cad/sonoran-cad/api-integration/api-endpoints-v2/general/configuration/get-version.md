---
description: >-
  Retrieve the stored community plan version metadata associated with the
...
local response = sonoran.cad:getVersionV2()
...
```lua
local response = cad:getVersionV2()
...
(async () => {
  ...
  const response = await instance.cad.getVersionV2();
...
response = instance.cad.getVersionV2()
...
openapi: "3.0.3"
info:
  title: "Sonoran CAD v2 - Get Version"
  version: "1.0.0"
