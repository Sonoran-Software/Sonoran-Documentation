...
local response = sonoran.cad:removeRecordV2(501)
...
```lua
local response = cad:removeRecordV2(501)
...
response = instance.cad.removeRecordV2(501)
...
var response = await sonoran.Cad.removeRecordV2(451);
