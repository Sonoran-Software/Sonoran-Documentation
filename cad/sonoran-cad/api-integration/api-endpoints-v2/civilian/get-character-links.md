---
description: >-
  Retrieve linked sync-character IDs for a community user, linked Roblox user,
  linked Discord user, or account.
---
...
```lua
local response = cad:getCharacterLinksV2({
    accountUuid = '00000000-0000-0000-0000-000000000000',
  })
...
var response = await sonoran.Cad.getCharacterLinksV2(new GetCharacterLinksV2Query
{
...
info:
  ...
  version: "1.0.0"
  description: "Retrieve linked sync-character IDs for a community user, linked Roblox user, linked Discord user, or account."
servers:
  -
