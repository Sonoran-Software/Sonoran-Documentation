...
When running our [desktop application](../download.md), Discord can automatically detect and display information about your community.
...
![Discord Developer - New Application](<../.gitbook/assets/image (42).png>)

#### 2. Copy your Client ID

Under OAuth2, copy your `Client ID`

![Discord Developer - Application Client ID](<../.gitbook/assets/image (1) (2).png>)
