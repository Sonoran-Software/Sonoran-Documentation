...
CMS 1.6.35 adds the expanded snapshot, including ClockIn, whitelist, JobSync, and ACE permissions module configuration files, plus API version/error and debug state.
