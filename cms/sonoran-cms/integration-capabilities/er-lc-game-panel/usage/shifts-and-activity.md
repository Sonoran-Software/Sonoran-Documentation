---
description: Learn more about powerful time tracking with the ER:LC panel!
---
...
When a user joins the ER:LC game server, an automatic activity timer starts. This timer captures a start and stop time log based on your team. These time logs can be [displayed on a roster](cms-integrations.md#roster-activity-time), or be shown in one of the integrations below.
