...
async function main() {
  ...
  const response = await instance.cms.setDisciplinaryRecordStatusV2(recordId, payload);
...
response = instance.cms.setDisciplinaryRecordStatusV2(recordId, payload)
...
var response = await sonoran.Cms.setDisciplinaryRecordStatusV2(recordId, payload);
