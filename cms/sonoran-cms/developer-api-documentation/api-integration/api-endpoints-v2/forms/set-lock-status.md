...
async function main() {
  ...
  const response = await instance.cms.setFormLockV2(templateId, payload);
...
response = instance.cms.setFormLockV2(templateId, payload)
...
var response = await sonoran.Cms.setFormLockV2(templateId, payload);
