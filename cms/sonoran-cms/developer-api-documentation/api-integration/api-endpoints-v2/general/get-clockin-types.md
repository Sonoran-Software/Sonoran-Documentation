...
local response = sonoran.cms:getClockInTypesV2()
...
async function main() {
  const response = await instance.cms.getClockInTypesV2();
...
response = instance.cms.getClockInTypesV2()
...
var response = await sonoran.Cms.getClockInTypesV2();
