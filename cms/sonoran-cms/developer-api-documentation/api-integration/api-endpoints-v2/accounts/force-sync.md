...
local response = sonoran.cms:forceSyncV2(accountId, payload)
...
async function main() {
  ...
  const response = await instance.cms.forceSyncV2(accountId, payload);
...
response = instance.cms.forceSyncV2(accountId, payload)
...
var response = await sonoran.Cms.forceSyncV2(accountId, payload);
