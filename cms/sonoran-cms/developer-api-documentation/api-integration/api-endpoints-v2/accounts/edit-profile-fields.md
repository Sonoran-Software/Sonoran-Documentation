...
local response = sonoran.cms:editProfileFieldsV2(accountId, payload)
...
async function main() {
  ...
  const response = await instance.cms.editProfileFieldsV2(accountId, payload);
...
response = instance.cms.editProfileFieldsV2(accountId, payload)
...
var response = await sonoran.Cms.editProfileFieldsV2(accountId, payload);
