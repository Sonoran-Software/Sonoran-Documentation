---
description: >-
  View rosters and sort columns, filter values, search for users, export to CSV,
  and more!
---
...
Under **Admin** > **Website Builder** > [**Navigation Bar**](../community-website/toolbar-customization.md) > Communities can add a new button or dropdown that links to a specific roster. If the roster is restricted to only specific ranks, the navigation button will only be visible to users with one of those ranks.
