---
description: Link your ER:LC private server and Roblox account to Sonoran Radio.
---
...
<figure><img src="../../../.gitbook/assets/erlc-towers/erlc-unlinked-server.png" alt="ER:LC API key field and Link Server button"><figcaption><p>Enter your private-server API key to connect ER:LC.</p></figcaption></figure>

<figure><img src="../../../.gitbook/assets/erlc-towers/erlc-linked-server.png" alt="Linked ER:LC private server with a join code and Unlink button"><figcaption><p>The join code appears once the server is linked.</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/erlc-towers/erlc-account-link.png" alt="Link Roblox banner in Sonoran Radio"><figcaption><p>The banner appears above the radio panel for players who have not linked Roblox.</p></figcaption></figure>
...
<details>
<summary>Replace the API key or disconnect the server</summary>
