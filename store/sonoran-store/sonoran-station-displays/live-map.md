---
description: >-
  Configure the calibrated GTA V satellite map, modes, markers, interaction, and
  debugging.
tags:
  - live map
  - coordinates
...
<figure><img src="../.gitbook/assets/station-displays-live-map-auto-fit.webp" alt="Sonoran Station Displays Follow Units map mode"><figcaption><p>Follow Units using the same dense controlled unit dataset as Auto Fit; the matching viewport is expected for this dataset.</p></figcaption></figure>
