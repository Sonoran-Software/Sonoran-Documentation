---
description: >-
  Resolve common CCTV installation, camera, permission, recording, playback, and
...
* Terminal-specific access with `cctv.terminal.<terminalId>`
* Remote group access with `cctv.remote.<group>`
